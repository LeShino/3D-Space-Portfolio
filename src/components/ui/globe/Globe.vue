...
const props = defineProps({
  ...
  mass: { type: Number, required: false, default: 1 },
  tension: { type: Number, required: false, default: 280 },
  friction: { type: Number, required: false, default: 100 },
  precision: { type: Number, required: false, default: 0.001 },
});

const globeCanvasRef = ref();
const phi = ref(0);
const width = ref(0);
